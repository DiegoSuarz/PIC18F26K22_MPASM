...
LOOP
	    CALL	ADC_CONFIG	    ;LLAMO A RUTINA DE CONFG_ADC    
	    MOVFF	RESULTADO_H,LATC    ;ALMACENO EL VALOR ALTO DEL ADC Y LO MUEVO AL PUERTO C
	    MOVFF	RESULTADO_L,LATB    ;ALMACENO EL VALOR BAJO DEL ADC Y LO MUEVO AL PUERTO B
	    CALL	RET_1ms
	    GOTO	LOOP
...
ADC_CONVERSION
	    ...
	    MOVFF	ADRESH,RESULTADO_H  ;MUEVO LA PARTE ALTA DE LA CONVERSION A LA VARIABLE RESULTADO_H
