...
#DEFINE	    MOV_HORARIO		PORTA,0	;PIN DE CONTROL PINB0 SERVO 1
#DEFINE	    MOV_ANTIHORARIO	PORTA,1	;PIN DE CONTROL PINB1 SERVO 2 
...
PRINCIPAL
	    BTFSS	MOV_HORARIO
	    GOTO	START_HORARIO
	    BTFSS	MOV_ANTIHORARIO
	    GOTO	START_ANTIHORARIO
	    BCF		LATB,0
	    BCF		LATB,1
	    GOTO	PRINCIPAL
