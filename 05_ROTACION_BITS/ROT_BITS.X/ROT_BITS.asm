...
;ROTAR A LA IZQUIERDA
	    ;CALL	RET_500ms
	   ;; RLCF	LATC,F		    ;ROTA EL BIT LSB A LA IZQUIERDA DEL PUERTO C CON CARRY Y MUEVELO AL REGISTRO LATC 
	    ;RLNCF	LATC,F		    ;ROTA EL BIT LSB A LA IZQUIERDA DEL PUERTO C SIN CARRY Y MUEVELO AL REGISTRO LATC 
	    ;BTFSS	STATUS,C	    ;EL BIT CARRY ESTA EN ALTO?
;	    GOTO	PRINCIPAL	    ;NO->VE A PRINCIPAL
;	    BSF		LATB,7		    ;SI-> ENCIENDE EL PIN RB7
;	    CALL	RET_500ms
;	    BCF		LATB,7
;	    GOTO	PRINCIPAL
...
;ROTAR A LA DERECHA
	    CALL	RET_500ms
	    RRCF	LATC,F		    ;ROTA EL BIT LSB A LA DERECHA DEL PUERTO C CON CARRY Y MUEVELO AL REGISTRO LATC 
	    ;RRNCF	LATC,F		    ;ROTA EL BIT LSB A LA DERECHA DEL PUERTO C SIN CARRY Y MUEVELO AL REGISTRO LATC 
	    BTFSS	STATUS,C	    ;EL BIT CARRY ESTA EN ALTO?
	    GOTO	PRINCIPAL	    ;NO->VE A PRINCIPAL
	    BSF		LATB,7		    ;SI-> ENCIENDE EL PIN RB7
	    CALL	RET_500ms
