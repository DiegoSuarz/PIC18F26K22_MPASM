;DESCRIPCION:
;	CONFIGURAR Y USAR LAS INTERRUPCIONES EXTERNAR DEL uC
;ZONA DE DATOS ******************************************************************************************
    List p=18F26k22
...
PRINCIPAL
	    ...
	    MOVF	CONTADOR,W		    ;LEER EL VALOR QUE TIENE LA VARIABLE CONTADOR Y MOVERLO A W
	    MOVWF       LATC			    ;W->PUERTO C
	    INCF	CONTADOR,F		    ;INCREMENTAR LA VARIABLE CONTADOR EN UNA UNIDAD Y ALMACENARLO EN W	
	    CALL	RET_500ms
	    GOTO	PRINCIPAL
