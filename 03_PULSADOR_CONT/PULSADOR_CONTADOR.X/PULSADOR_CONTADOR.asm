;DESCRIPCION:
;	REALIZAR UN CONTADOR CONTROLADO POR UN PULSADOR
;ZONA DE DATOS ******************************************************************************************
...
INICIO	
	    ...
	    BSF		TRISA,0		    ; PIN RA0 COMO ENTRADA DIGITAL
...
PRINCIPAL
	    ...
	    BTFSC	PORTA,0		    ;EN PIN RA0 ESTA EN NIVEL BAJO?
	    GOTO	PRINCIPAL	    ;SI EL PIN RA0 ES 1 SE GENERA UN BUCLE
	    CALL	RET_500ms
	    GOTO	DIGITO_UNO
...
DIGITO_UNO
	    ...
	    BTFSC	PORTA,0		    ;EN PIN RA0 ESTA EN NIVEL BAJO?
	    GOTO	DIGITO_UNO	    ;SI EL PIN RA0 ES 1 SE GENERA UN BUCLE
	    CALL	RET_500ms
...
DIGITO_DOS
	    ...
	    MOVWF	LATC
	    BTFSC	PORTA,0		    ;EN PIN RA0 ESTA EN NIVEL BAJO?
	    GOTO	DIGITO_DOS	    ;SI EL PIN RA0 ES 1 SE GENERA UN BUCLE
	    CALL	RET_500ms
...
DIGITO_TRES
	    ...
	    MOVWF	LATC
	    BTFSC	PORTA,0		    ;EN PIN RA0 ESTA EN NIVEL BAJO?
	    GOTO	DIGITO_TRES	    ;SI EL PIN RA0 ES 1 SE GENERA UN BUCLE
	    CALL	RET_500ms
...
DIGITO_CUATRO
	    ...
	    MOVWF	LATC
	    BTFSC	PORTA,0		    ;EN PIN RA0 ESTA EN NIVEL BAJO?
	    GOTO	DIGITO_CUATRO	    ;SI EL PIN RA0 ES 1 SE GENERA UN BUCLE
	    CALL	RET_500ms
...
DIGITO_CINCO
	    ...
	    MOVWF	LATC
	    BTFSC	PORTA,0	
	    GOTO	DIGITO_CINCO	    ;SI EL PIN RA0 ES 1 SE GENERA UN BUCLE
	    CALL	RET_500ms
...
DIGITO_SEIS
	    ...
	    MOVWF	LATC
	    BTFSC	PORTA,0	
	    GOTO	DIGITO_SEIS	    ;SI EL PIN RA0 ES 1 SE GENERA UN BUCLE
	    CALL	RET_500ms
...
DIGITO_SIETE
	    ...
	    MOVWF	LATC
	    BTFSC	PORTA,0	
	    GOTO	DIGITO_SIETE	    ;SI EL PIN RA0 ES 1 SE GENERA UN BUCLE
	    CALL	RET_500ms
...
DIGITO_OCHO
	    ...
	    MOVWF	LATC
	    BTFSC	PORTA,0	
	    GOTO	DIGITO_OCHO	    ;SI EL PIN RA0 ES 1 SE GENERA UN BUCLE
	    CALL	RET_500ms
...
DIGITO_NUEVE
	    ...
	    CALL	RET_500ms
	    BTFSC	PORTA,0	
	    GOTO	DIGITO_NUEVE	    ;SI EL PIN RA0 ES 1 SE GENERA UN BUCLE
	    CALL	RET_500ms
	    GOTO	PRINCIPAL
