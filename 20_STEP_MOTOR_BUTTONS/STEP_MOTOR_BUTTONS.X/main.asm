...
PRINCIPAL
	    ...
	    BTFSS	SW_HORARIO		;EL PULSADOR RA0 ESTA EN ALTO? SI, SALTA UNA INSTRUCCION, NO, SIGUE A LA SIGUIENTE INSTRUCCION
	    CALL	HORARIO			;NO, ESTA EN BAJO, VE A LA SUBRUTINA HORARIO
	    BTFSS	SW_ANTIHORARIO		;SI ESTA EN ALTO, PREGUNTA EL PULSADOR RA1 ESTA EN ALTO? SI, SALTA UNA INSTRUCCION, NO, SIGUE A LA SIGUIENTE INSTRUCCION
	    CALL	ANTIHORARIO		;NO, ESTA EN BAJO, VE A LA SUBRUTINA ANTIHORARIO
	    GOTO	PRINCIPAL		;SI ESTA EN ALTO, VE A LA ETIQUETA PRINCIPAL Y REPITE EL PROCESO
