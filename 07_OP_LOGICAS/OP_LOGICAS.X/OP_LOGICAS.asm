...
;*********************************************************************************
INICIO	
	    BSF		OSCCON,IRCF2	    ;CONFIGURACION DEL OSCILADOR INTERNO
	    ...
	    SETF    	TRISA		    ; ENTRADA DIGITALES PUERTO A
	    SETF	TRISB		    ; ENTRADA DIGITALES PUERTO B
...
;OPERACION LOGICA COMPLEMENTO (NOT)
;	    COMF	PORTA,W
;	    MOVWF	LATC
;	    GOTO	PRINCIPAL
	    
	    
;OPERACION LOGICA OR INCLUSIVA(OR):
;	    MOVF	PORTA,W
;	    IORWF	PORTB,W
;	    MOVWF	LATC
;	    GOTO	PRINCIPAL
	    
;OPERACION LOGICA OR EXCLUSIVA(XOR):
	    MOVF	PORTA,W
	    XORWF	PORTB,W
	    MOVWF	LATC
	    GOTO	PRINCIPAL	
